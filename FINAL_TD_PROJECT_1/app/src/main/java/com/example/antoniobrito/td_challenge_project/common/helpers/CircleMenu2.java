 ...
 */
public class CircleMenu2 extends View {
    ...
    public CircleMenu2(Context context) {
        this(context, null);
    }

    public CircleMenu2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleMenu2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        partSize = minSize / 6;
        iconSize = partSize * 4 / 2;
        circleMenuRadius = (float) (partSize * 2.05);
     ...
     * @return
     */
    public CircleMenu2 addSubMenu(int menuColor, int menuRes) {
     ...
     * @return
     */
    public CircleMenu2 addSubMenu(int menuColor, Bitmap menuBitmap) {
        if (subMenuColorList.size() < MAX_SUBMENU_NUM && subMenuDrawableList.size() < MAX_SUBMENU_NUM) {
            subMenuColorList.add(menuColor);
     ...
     * @return
     */
    public CircleMenu2 addSubMenu(int menuColor, Drawable menuDrawable) {
        if (subMenuColorList.size() < MAX_SUBMENU_NUM && subMenuDrawableList.size() < MAX_SUBMENU_NUM) {
            subMenuColorList.add(menuColor);
    ...
    public CircleMenu2 setOnMenuSelectedListener(OnMenuSelectedListener listener) {
        this.onMenuSelectedListener = listener;
        return this;
    }

    public CircleMenu2 setOnMenuStatusChangeListener(OnMenuStatusChangeListener listener) {
